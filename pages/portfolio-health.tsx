...
export default function PortfolioHealthPage() {
  ...
  return (
    <>
      <SEO
        title="What Aren't Your Founders Telling You? | Portfolio Health - Pitch-it"
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 rounded-lg p-8">
                <p className="text-gray-700 italic mb-6">
                  "We discovered our star portfolio company was about to lose their CTO. The early warning gave us time to help with retention. That one save paid for Pitch-it for 5 years."
                </p>
                <div className="flex items-center">
                  <img
