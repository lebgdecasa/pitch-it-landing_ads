...
export default function ForFoundersPage() {
  ...
  return (
    <>
      <SEO
        title="For Founders | NexTraction - AI-Powered Fundraising Platform"
        description="Validate your idea, build compelling pitch decks, and practice with AI before meeting real investors. Join 500+ founders using NexTraction."
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-blue-50 p-8 rounded-lg">
                <p className="text-lg mb-4 italic">"NexTraction helped me realize my initial idea wouldn't scale. The pivot saved me 6 months and $50k."</p>
        ...
        <section className="py-20 bg-blue-600 text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Join 500+ founders who've validated their ideas and raised funding faster with NexTraction
            </p>
