...
export default function VCToolkitPage() {
  ...
  return (
    <>
      <SEO
        title="From Deck to Decision in Minutes | VC Toolkit - Pitch-it"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                <img src="/images/logo.png" alt="Pitch-it" className="h-8 mr-2" />
                <span className="font-bold text-xl text-gray-900">Pitch-it</span>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 rounded-lg p-8">
                ...
                <p className="text-gray-700 italic">
                  "Pitch-it has transformed our deal flow process. We're seeing higher quality startups that are better prepared, and our initial evaluation time has dropped by 80%. It's become an essential tool for our team."
                </p>
              </div>
        ...
        <section className="py-12 md:py-20 px-4 md:px-6 bg-green-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join 50+ VCs who are finding and evaluating deals faster with Pitch-it
            </p>
