...
export default function VsValidatelyPage() {
  ...
  const features = [
    {
      ...
      items: [
        ...
        { feature: "AI-powered insights", pitchit: true, validately: false, difference: "Exclusive to NexTraction" },
        { feature: "Competitor analysis", pitchit: true, validately: false, difference: "Exclusive to NexTraction" },
        { feature: "Trend identification", pitchit: true, validately: false, difference: "Exclusive to NexTraction" }
      ]
    },
    {
      ...
      items: [
        ...
        { feature: "Virtual VC practice", pitchit: true, validately: false, difference: "Exclusive to NexTraction" },
        { feature: "Pitch deck builder", pitchit: true, validately: false, difference: "Exclusive to NexTraction" },
  ...
  const switcherTestimonials = [
    ...
    },
    {
      ...
      quote: "Validately was fine for surveys, but NexTraction's virtual VC practice got us funded.",
      benefit: "Raised $1.2M",
    ...
    },
    {
      ...
      quote: "The migration was seamless. NexTraction imported all our data and we were running in minutes.",
  ...
  return (
    <>
      <SEO
        title="NexTraction vs Validately: The Honest Comparison | See Why VCs Prefer NexTraction"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900 leading-tight">
                <span className="text-blue-600">NexTraction</span> vs Validately:<br />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-xl overflow-hidden">
              ...
              <div className="grid grid-cols-12 bg-gray-800 text-white p-4">
                ...
                <div className="col-span-2 text-center font-medium">NexTraction</div>
